...
```
Production: `https://naxely.com,https://www.naxely.com`. Dev: `http://localhost:5173`. No wildcard.
...
Settings.tsx upgrade CompactPlanCard: links to `https://naxely.com/pricing`
