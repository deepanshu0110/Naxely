  ...
  return (
    <div className="min-h-screen bg-paper text-ink" data-bust="2026-08-24-mobile-nav">
      <Head>
        ...
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is Naxely free to use?","acceptedAnswer":{"@type":"Answer","text":"Yes — the Free tier includes 3 reports/month with CSV upload and basic charts, no credit card required."}},{"@type":"Question","name":"Do I need my own AI API key?","acceptedAnswer":{"@type":"Answer","text":"Not on the Free tier — Naxely supplies AI generation for your 3 monthly reports. Pro and Agency use bring-your-own-key: Gemini, Groq, DeepSeek, OpenAI, Claude, Mistral, and Together AI — you pay the provider directly with no markup."}},{"@type":"Question","name":"Can I remove the Naxely branding from reports?","acceptedAnswer":{"@type":"Answer","text":"The watermark is removed on Pro and Agency plans. Agency plans also remove all Naxely branding for full white-label output."}},{"@type":"Question","name":"Does Naxely support Google Sheets?","acceptedAnswer":{"@type":"Answer","text":"Yes, on Pro and above — paste a Sheets URL directly, no CSV export needed."}},{"@type":"Question","name":"How long does report generation take?","acceptedAnswer":{"@type":"Answer","text":"Typically in under a minute."}},{"@type":"Question","name":"Does Naxely have an API for the Agency tier?","acceptedAnswer":{"@type":"Answer","text":"Yes — the Agency plan includes programmatic API access: POST /v1/reports with an X-API-Key header, so you can generate branded reports directly from your own systems."}},{"@type":"Question","name":"How do I choose the right plan?","acceptedAnswer":{"@type":"Answer","text":"It depends on your data source and workflow. If you work mostly from CSV exports, the Free tier covers 3 reports/month. If you need Google Sheets integration, unlimited reports, or AI insights, Pro at $29/month is the common starting point. For a full evaluation framework, see our guide to choosing client reporting software."}},{"@type":"Question","name":"Is Naxely suitable for freelancers?","acceptedAnswer":{"@type":"Answer","text":"Yes — Naxely was built for freelance analysts, consultants, and small agencies working from client-provided exports rather than live ad-platform data. The Free tier covers 3 reports/month with CSV and Excel upload and basic charts, no credit card required, and BYOK keeps AI costs at provider price even at low volume. Reports generate in under a minute."}}]})}</script>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-3">
            ...
            <details className="group cursor-pointer rounded-xl border border-gray-200 bg-paper p-5">
              ...
              <p className="mt-3 text-sm text-ink/55 leading-relaxed">
                Not on the Free tier — Naxely supplies AI generation for your 3 monthly reports. Pro and Agency use bring-your-own-key: Gemini, Groq, DeepSeek, OpenAI, Claude, Mistral, and Together AI — you pay the provider directly with no markup.
              </p>
            </details>
            <details className="group cursor-pointer rounded-xl border border-gray-200 bg-paper p-5">
              <summary className="flex items-center justify-between text-sm font-semibold text-ink list-none">
            ...
            <details className="group cursor-pointer rounded-xl border border-gray-200 bg-paper p-5">
              <summary className="flex items-center justify-between text-sm font-semibold text-ink list-none">
                Does Naxely have an API for the Agency tier?
                <span className="text-amber-500 transition-transform group-open:rotate-180">▼</span>
              </summary>
              <p className="mt-3 text-sm text-ink/55 leading-relaxed">
                Yes — the Agency plan includes programmatic API access: POST /v1/reports with an X-API-Key header, so you can generate branded reports directly from your own systems.
              </p>
            </details>
            <details className="group cursor-pointer rounded-xl border border-gray-200 bg-paper p-5">
              <summary className="flex items-center justify-between text-sm font-semibold text-ink list-none">
              ...
              <p className="mt-3 text-sm text-ink/55 leading-relaxed">
                It depends on your data source and workflow. If you work mostly from CSV exports, the Free tier covers 3 reports/month. If you need Google Sheets integration, unlimited reports, or AI insights, Pro at $29/month is the common starting point. For a full evaluation framework, see our guide to <Link to="/blog/client-reporting-software-guide" className="text-amber-600 hover:text-amber-700 underline">choosing client reporting software</Link>.
              </p>
            </details>
            <details className="group cursor-pointer rounded-xl border border-gray-200 bg-paper p-5">
              <summary className="flex items-center justify-between text-sm font-semibold text-ink list-none">
                Is Naxely suitable for freelancers?
                <span className="text-amber-500 transition-transform group-open:rotate-180">▼</span>
              </summary>
              <p className="mt-3 text-sm text-ink/55 leading-relaxed">
                Yes — Naxely was built for freelance analysts, consultants, and small agencies working from client-provided exports rather than live ad-platform data. The Free tier covers 3 reports/month with CSV and Excel upload and basic charts, no credit card required, and BYOK keeps AI costs at provider price even at low volume. Reports generate in under a minute. For a full breakdown of how Naxely compares for freelancers, see our guide to <Link to="/blog/best-client-reporting-software-freelancers" className="text-amber-600 hover:text-amber-700 underline">best client reporting software for freelancers</Link>.
              </p>
            </details>
          </div>
