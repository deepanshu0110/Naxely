  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      <Head>
        ...
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Can I cancel anytime?","acceptedAnswer":{"@type":"Answer","text":"Yes, cancel any time — access continues until the end of your billing period."}},{"@type":"Question","name":"Do I need a credit card for the free plan?","acceptedAnswer":{"@type":"Answer","text":"No. The free plan requires no payment information."}},{"@type":"Question","name":"What AI providers are supported?","acceptedAnswer":{"@type":"Answer","text":"Gemini, Groq, DeepSeek, OpenAI, Claude, Mistral, and Together AI — bring your own API key, no markup."}},{"@type":"Question","name":"Is my data secure?","acceptedAnswer":{"@type":"Answer","text":"Yes — files are encrypted in transit and at rest. CSV files are deleted immediately after your report is generated."}},{"@type":"Question","name":"Can agencies white-label reports?","acceptedAnswer":{"@type":"Answer","text":"Yes — the Agency plan removes all Naxely branding."}}]})}</script>
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"Product","name":"Naxely","url":"https://www.naxely.com/pricing","description":"Simple, transparent pricing for Naxely. Start free, upgrade when you need more. Plans from $0 to $79/month.","brand":{"@type":"Organization","name":"Naxely"},"offers":plans.map((p)=>({"@type":"Offer","name":p.name,"price":p.price.replace("$",""),"priceCurrency":"USD","url":p.name==="Free"?`https://www.naxely.com${p.href}`:"https://www.naxely.com/pricing","availability":"https://schema.org/InStock"}))})}</script>
      </Head>
      <Navbar />
