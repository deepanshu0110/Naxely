    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      ...
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mx-auto max-w-xl text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
          ...
          <p><em>Update (September 2026): this changed for Free.</em> Pro and Agency still require the user's own AI API key — no server-side fallback on those tiers, which is deliberate: no shared-quota throttling, no AI markup hiding in the price. But the Free tier no longer asks for a key up front — Naxely supplies AI generation for your 3 monthly reports, because requiring a Groq or Gemini key before a first report turned out to be real friction I couldn't keep accepting on purpose.</p>
