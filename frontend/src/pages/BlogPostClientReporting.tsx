    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      ...
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
          ...
          <p>Naxely includes white-label PDF output on its Agency tier at $79/month — roughly half the price of DashThis's white-label entry point — and includes send-to-client email and programmatic API access at the same tier. Other tools like AgencyAnalytics and Whatagraph also offer white-label options, typically on their highest pricing plans.</p>
          ...
          <p>In most tools, yes — white-label features are gated behind higher pricing tiers. DashThis requires the Professional plan ($139/mo) for custom domain, branding removal, and logo/theme customization; its Individual plan ($44/mo billed yearly) does not include white-labeling. Naxely includes white-label PDF output on its Agency tier ($79/month). AgencyAnalytics and Whatagraph also gate white-labeling behind their premium plans. Before signing up, check which specific white-label features are included at which price tier, because the feature can add $40–100+ per month to your base cost.</p>
      ...
      <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        ...
        {"@type":"Question","name":"Does white-label reporting cost extra?","acceptedAnswer":{"@type":"Answer","text":"In most tools, yes. DashThis requires the Professional plan ($139/mo) for white-label features; its Individual plan ($44/mo billed yearly) does not include it. Naxely includes white-label PDF output on its Agency tier ($79/month). AgencyAnalytics and Whatagraph also gate white-labeling behind premium plans. Check which features are included at each tier before committing."}}
      ]})}</script>
