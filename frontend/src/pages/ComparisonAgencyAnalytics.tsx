...
export default function ComparisonAgencyAnalytics() {
  return (
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      <Head>
        <title>AgencyAnalytics Alternative for Freelancers & Agencies | Naxely</title>
        ...
        <meta property="og:title" content="AgencyAnalytics Alternative for Freelancers & Agencies | Naxely" />
