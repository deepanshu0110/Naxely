    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      ...
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mx-auto max-w-xl text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
          ...
          <p>Report generation in Naxely needs no setup at all — upload a CSV, and Naxely handles chart selection, insight writing, and formatting automatically. For the AI features, Naxely uses a BYOK (bring-your-own-key) model on Pro and above: connect your own API key from one of seven supported providers (Gemini, Groq, DeepSeek, OpenAI, Claude, Mistral, or Together AI) in about 2 minutes, and there's no markup on AI usage. The Free tier includes AI with no key needed. <Link to="/blog/byok-ai-reporting-tool" className="text-amber-600 hover:text-amber-700 underline">Read more about how BYOK works &rarr;</Link></p>
