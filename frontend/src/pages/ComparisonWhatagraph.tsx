    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      <Head>
        ...
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
          ...
          {"@type":"Question","name":"Does Naxely offer a free trial like Whatagraph?","acceptedAnswer":{"@type":"Answer","text":"Naxely\u2019s free tier is a permanent plan (3 reports/month) with no credit card required. Whatagraph's pricing page invites you to book a demo. For low-volume users, Naxely\u2019s free tier is a no-expiration trial."}}
        ]})}</script>
      </Head>
      <Navbar />
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <td className="py-2 text-ink/55 dark:text-paper/45">Live API connectors — credit-based (1 credit per connected account). From 50 credits on Max plan, custom on Prime</td>
                </tr>
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <td className="py-2 text-ink/55 dark:text-paper/45">€699/mo billed annually (Max plan); custom pricing for Prime</td>
                </tr>
                <tr className="border-b border-gray-100 dark:border-gray-800">
                ...
                <tr className="border-b border-gray-100 dark:border-gray-800">
                  ...
                  <td className="py-2 text-ink/55 dark:text-paper/45">Custom branding included on Max plan (€699/mo); custom report domain available as add-on on Prime</td>
                </tr>
                <tr className="border-b border-gray-100 dark:border-gray-800">
          ...
          <p>Naxely's free tier is a permanent free plan (3 reports/month with AI insights and white-label branding) — no credit card required, no time limit. Whatagraph invites you to book a demo of its plans. For low-volume users, Naxely's free tier is effectively a no-expiration trial.</p>

          <p className="text-xs text-ink/50 dark:text-paper/40">If you&rsquo;re weighing credit-based multi-channel dashboards against per-report pricing, see how Naxely stacks up against <Link to="/compare/dashthis" className="text-amber-600 hover:text-amber-700 underline underline-offset-2 decoration-amber-500/30">DashThis</Link> and <Link to="/compare/agencyanalytics" className="text-amber-600 hover:text-amber-700 underline underline-offset-2 decoration-amber-500/30">AgencyAnalytics</Link>.</p>
