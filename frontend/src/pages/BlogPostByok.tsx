    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      ...
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mx-auto max-w-xl text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
          ...
          <p>Sign up for Naxely's free tier (no credit card required), paste your AI provider's API key into Settings, upload a CSV (or Google Sheets URL on Pro and above), and Naxely generates a branded client-ready PDF report in under a minute using your key at cost — with 16+ chart types, AI-written insights, and zero markup.</p>
