    ...
    <div className="min-h-screen bg-paper dark:bg-darkBg">
      ...
      <article className="mx-auto max-w-2xl px-6 py-24">
        ...
        <div className="mx-auto max-w-xl text-ink/55 dark:text-paper/45 text-sm leading-relaxed space-y-5">
          ...
          <p>BYOK is not right for everyone. The tradeoff is simple: on Pro and Agency you save significant money over time, but you do need to create one API key one time as a one-time setup step. For most freelancers and small agencies, this two-minute setup pays for itself within the first month through avoided markup — but if you'd genuinely rather not manage any external account at all, Naxely's Free tier includes AI with no key needed, and a fully bundled tool may suit you better.</p>

          <h2 className="font-semibold text-ink dark:text-paper text-base mt-8">How do I try BYOK with Naxely?</h2>
          <p>Sign up for Naxely's free tier (no credit card required, no API key needed — AI is included), upload a CSV (or Google Sheets URL on Pro and above), and Naxely generates a branded client-ready PDF report in under a minute — with 16+ chart types, AI-written insights, and zero markup. On Pro and above you can paste your own provider key into Settings to use it at cost instead.</p>
